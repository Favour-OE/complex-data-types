...
let newArray = ['python', 'javascript', 'golang']
...
growMe.splice(growMe.length,0, "three")
...
let ticTacToeWinner = (ticTacToeArray[0][0] === ticTacToeArray[1][1]) && (ticTacToeArray[1][1] === ticTacToeArray[2][2]) && (ticTacToeArray[0][0] !== "")
